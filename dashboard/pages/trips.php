                        ...
                        <div class="content">
                          ...
                          <?php 
                            if(isset($_POST['submit'])){
                              ...
                              $Trip = mysqli_query($conn,"INSERT INTO `trips` (CatagoryName,subCatagoryName,Title,TripDescription,TripPrice,Media,QuantityAvailable,quantity) 
                              VALUES ('$category','$Subcategory','$Title','$Offers','$Price','$folder','$quantity','$quantity')");
